...
file_path = '../data/SAS Dataset/Thoracic/thoracic_data.csv'
df = pd.read_csv(file_path, low_memory=False, encoding='utf-8')
# donornet_donors = pd.read_parquet('../data/donornet/donors.parquet', engine='pyarrow')
# donornet_offers = pd.read_parquet('../data/donornet/offers.parquet', engine='pyarrow')
