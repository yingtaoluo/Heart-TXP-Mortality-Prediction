...
# df = pd.read_stata(f"{DATA}/CTR_IDS/donor_ctr_ids.dta", convert_categoricals=False)
# pdb.set_trace()

# target_directory = f'{DATA}/CODE DICTIONARY'
# target_directory = f'{DATA}/mybox-selected/STAR_SAS/SAS Dataset 202312/SAS Dataset 202312/Thoracic'
# target_directory = f"{DATA}/mybox-selected/STAR_STATA/CODE DICTIONARY - FORMATS 202312/Thoracic"
# target_directory = f"{DATA}/donornet/DonorNet_SAS"
target_directory = f"{DATA}/CTR_IDS"
process_directory(target_directory)

# process_donornet(f'{DATA}/donornet/donors.parquet')
# process_donornet(f'{DATA}/donornet/offers.parquet')
