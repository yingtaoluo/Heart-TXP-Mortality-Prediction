...
if analyze_full_data:
    X = pd.read_csv(f'{DATASETS}/{{}}YEAR/TXP_data_{{}}_imputed_full.csv'.format(YEARS, benchmark_choice))
    y = pd.read_csv(f'{DATASETS}/{{}}YEAR/TXP_label_{{}}_full.csv'.format(YEARS, benchmark_choice)).squeeze()
else:
    X = pd.read_csv(f'{DATASETS}/{{}}YEAR/TXP_data_{{}}_imputed.csv'.format(YEARS, benchmark_choice))
    y = pd.read_csv(f'{DATASETS}/{{}}YEAR/TXP_label_{{}}.csv'.format(YEARS, benchmark_choice)).squeeze()
...
for seed in range(num_runs):
    ...
    if 'Logistic' in models_to_test:
        if hp_search:
            param_file = f'{CHECKPOINTS}/{{}}YEAR/best_params_{{}}_{{}}.json'.format(YEARS, benchmark_choice, 'Linear')
        ...
        model_file = f'{CHECKPOINTS}/{{}}YEAR/logit_model_{{}}.pkl'.format(YEARS, benchmark_choice)
        ...
        if seed == 0:
            coefficients.to_csv(f'{RESULTS}/{{}}YEAR/multivariate_results.csv'.format(YEARS))
            significant_coefs.to_csv(f'{RESULTS}/{{}}YEAR/significant_multivariate_results.csv'.format(YEARS))
    ...
    if 'XGBoost' in models_to_test:
        ...
        if hp_search:
            ...
            model_file = f'{CHECKPOINTS}/{{}}YEAR/XGBoost_model_{{}}.pkl'.format(YEARS, benchmark_choice)
